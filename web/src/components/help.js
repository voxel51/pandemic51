...
export default function SimpleModal() {
        ...
        <Typography variant="h3" component="h2" style={{marginBottom: "2rem"}}>
          How to use the graph
            ...
            <Typography variant="h5" component="p" color="textSecondary">
              ...
              <Hidden mdUp>
                Click on live video streams from some of the world’s most visited streets to see how different cities react to physical distancing. An image of our detections from the time will overlay the video stream.
              </Hidden>
            </Typography>
      <SimpleModal />
    </CardContent>
  ...
  return (
    <div>
      <IconButton type="button" onClick={handleOpen} style={{position: "absolute", top: 0, right: 0}}>
        <HelpIcon/>
      </IconButton>
      <Modal
        open={open}
        ...
        style={{border: "none", margin: "auto", display:'flex',alignItems:'center',justifyContent:'center'}}
      >
        {body}
      </Modal>
    </div>
